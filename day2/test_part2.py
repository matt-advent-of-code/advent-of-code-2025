...
from day2.part2 import invalid_ids, sum_invalid
...
class MyTestCase(unittest.TestCase):
    ...
    def test_ids2(self):
        ...
        self.assertEqual([99, 111], invalid)

    def test_ids3(self):
        invalid = invalid_ids("998-1012")
        self.assertEqual([999, 1010], invalid)
    ...
    def test_sum(self):
        ...
        self.assertEqual(4174379265, sum_of_invalid)
